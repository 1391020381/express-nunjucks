define(function(require, exports , module){
    ...
    var docDiscount_var = '';                                           //有无折扣
    var orderBuyType_var = '';                                          //购买方式 -立即 或者 8折购
    var ifVIP_pvar = infoMessage[window.pageConfig.params.isVip];
    var ifLogin_pvar = infoMessage[0];
    var channelName_var = '';                                           //页面类型 办公频道或者其他
    ...
    //详情页初始化页面上报数据
    var gioReportInit = {
        docTypeLevel1_var:pageConfig.params.classidName1 || '',         //文档所属的一级分类
        docTypeLevel2_var:pageConfig.params.classidName2 || '',         //文档所属的二级分类
        docTypeLevel3_var:pageConfig.params.classidName3 || '',         //文档所属的三级分类
        docId_var:pageConfig.params.g_fileId || '',                     //文档id
        docTitle_var:pageConfig.params.file_title || '',                //文档标题
        docPayType_var:docPayType_var,                                  //文档付费类型
        docFormType_var:pageConfig.params.file_format || '',            //文档格式
        docSourceType_var:docSourceType_var,                            //文档来源
        channelName_var:channelName_var,                                //办公频道,其它
        ifVIP_pvar:ifVIP_pvar,                                          //是否vip
        ifLogin_pvar:ifLogin_pvar,                                      //是否登录
        lastEntryName_pvar:utils.findRefer(),                           //入口名称
    ...
    window.gioData = {
        ...
        "docSourceType_var":docSourceType_var,                          //文档来源
        "docPayType_var":docPayType_var,                                //文档付费类型
        "sourceName_var":sourceName_var,                                //合作渠道类型
        "channelName_var":channelName_var,                              //办公频道,其它
    ...
    window.gioPayDocReport = {
        orderId_var:'',                                                 //订单id
        docTypeLevel1_var:pageConfig.params.classidName1 || '',         //文档一级分类
        docTypeLevel2_var:pageConfig.params.classidName2 || '',         //文档二级分类
        docTypeLevel3_var:pageConfig.params.classidName3 || '',         //文档三级分类
        docId_var:pageConfig.params.g_fileId,                           //文档id
        docTitle_var:pageConfig.params.file_title,                      //文档名称
        docPayType_var:'',                                              //文档付费类型 免费 下载券 现金 vip免费 在线阅读
        docFormType_var:pageConfig.params.file_format,                  //文档格式
        docSourceType_var:docSourceType_var,                            //文档来源
        sourceName_var:sourceName_var,                                  //合作渠道类型
        docPayPrice_var:pageConfig.params.moneyPrice * 100,             //文档金额
        docDiscount_var:docDiscount_var,                                //文档折扣有折扣（8折），无折扣
        orderBuyType_var:orderBuyType_var,                              //购买方式  立即购买，加入vip8折购买
        orderPayType_var:'二维码合一',                                  //支付方式
        channelName_var:channelName_var,                                //办公频道,其它
        fileUid_var:pageConfig.params.file_uid,                         //文档上传者id
    };
