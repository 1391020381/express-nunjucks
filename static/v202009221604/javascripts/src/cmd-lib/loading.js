        ...
        $.fn.loading = function(options){
            ...
            return this.each(function(){
                ...
                var defaultProp = {
                    ...
                    borderRadius:     		6,                 									    //中间的背景色的borderRadius
                    loadingMaskBg:    		'rgba(0,0,0,0.6)',          								//背景遮罩层颜色
                    zIndex:           		1000001,              									//层级
    
                    // 这是圆形旋转的loading样式  
                    originDivWidth:        	10,           											//loadingDiv的width
                    originDivHeight:       	10,           											//loadingDiv的Height
                ...
                defaultProp._createLoading = function(){
                    ...
                    // opt.isClose && setTimeout(function(){
