define("dist/personalCenter/mywallet-debug", [ "../cmd-lib/jquery.datepicker-debug", "./home-debug", "swiper-debug", "../common/recommendConfigInfo-debug", "../application/method-debug", "../common/template/swiper_tmp-debug.html", "../application/api-debug", "../application/urlConfig-debug", "./template/homeRecentlySee-debug.html", "./template/vipPrivilegeList-debug.html", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../cmd-lib/upload/Q-debug", "../cmd-lib/upload/Q.Uploader-debug", "./template/simplePagination-debug.html", "./template/mywallet-debug.html", "../common/area-debug", "../common/bankData-debug", "./dialog-debug" ], function(require, exports, module) {
    ...
    function fullWithdrawal() {
        ...
        if (financeAccountInfo.userTypeName != "机构") {
            getPersonalAccountTax(balance * 100 - 1e4);
        }
    }
