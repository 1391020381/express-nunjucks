define("dist/personalCenter/personalinformation", [ "../application/api", "../application/urlConfig", "../application/method", "../cmd-lib/jquery.datepicker", "../common/area", "../application/effect", "../application/checkLogin", "../application/login", "../application/loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../cmd-lib/myDialog", "../cmd-lib/toast", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../common/loginType", "../common/associateWords", "./home", "swiper", "../common/recommendConfigInfo", "../common/template/swiper_tmp.html", "./template/homeRecentlySee.html", "./template/vipPrivilegeList.html", "./template/personalinformation.html" ], function(require) {
    ...
    $(document).on("click", ".personalinformation .edit-information", function() {
        // active-input
    ...
    $(document).on("change", ".personalinformation .item-province-select", function() {
