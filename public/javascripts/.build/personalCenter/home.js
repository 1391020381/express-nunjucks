define("dist/personalCenter/home", [ "swiper", "../common/recommendConfigInfo", "../application/method", "../common/template/swiper_tmp.html", "../application/api", "../application/urlConfig", "./template/homeRecentlySee.html", "./template/vipPrivilegeList.html", "../application/effect", "../application/checkLogin", "../application/login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics" ], function(require, exports, module) {
    require("swiper");
