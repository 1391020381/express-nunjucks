            ...
            success: function(res) {
                if (res.code == "0") {
                    if (res.data.rows && res.data.rows.length) {
                        var homeRecentlySeeTemplate = template.compile(homeRecentlySee)({
                            flag: "recentlySee",
                            data: res.data.rows || []
                        });
                    ...
                    $(recommendConfigInfo.personalCenterHome.descs).each(function(index, k) {
                        if (k.list.length) {
                            if (k.pageId == "PC_M_USER_banner") {
                                ...
                                var rbannerTemplate = template.compile(bannerTemplate)({
                                    topBanner: k.list,
