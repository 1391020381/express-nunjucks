define("dist/personalCenter/personalinformation-debug", [ "../application/api-debug", "../application/method-debug", "../cmd-lib/jquery.datepicker-debug", "../common/area-debug", "./effect-debug", "../application/checkLogin-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../report/init-debug", "../report/handler-debug", "../report/columns-debug", "../application/helper-debug", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min-debug", "./home-debug", "./template/homeRecentlySee-debug.html", "./template/personalinformation-debug.html" ], function(require, exports, module) {
