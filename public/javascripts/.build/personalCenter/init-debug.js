define("dist/personalCenter/init-debug", [ "../cmd-lib/tab-debug", "../cmd-lib/toast-debug", "../cmd-lib/myDialog-debug", "../application/suspension-debug", "../application/method-debug", "../application/checkLogin-debug", "../application/api-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../application/iframe/iframe-parent-debug", "../application/iframe/messenger-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../application/effect-debug", "../application/helper-debug", "./menu-debug", "./dialog-debug", "./home-debug", "swiper-debug", "../common/recommendConfigInfo-debug", "../common/template/swiper_tmp-debug.html", "./template/homeRecentlySee-debug.html", "./template/vipPrivilegeList-debug.html", "./mycollectionAndDownLoad-debug", "./template/mycollectionAndDownLoad-debug.html", "./template/simplePagination-debug.html", "./myuploads-debug", "./template/myuploads-debug.html", "./myvip-debug", "./template/myvip-debug.html", "./template/vipTable-debug.html", "./mycoupon-debug", "./template/mycoupon-debug.html", "./myorder-debug", "./template/myorder-debug.html", "./accountsecurity-debug", "./template/accountsecurity-debug.html", "./personalinformation-debug", "../cmd-lib/jquery.datepicker-debug", "../common/area-debug", "./template/personalinformation-debug.html", "./mywallet-debug", "../cmd-lib/clipboard-debug" ], function(require, exports, module) {
