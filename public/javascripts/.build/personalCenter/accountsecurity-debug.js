define("dist/personalCenter/accountsecurity-debug", [ "../cmd-lib/jqueryMd5-debug", "../application/method-debug", "../application/api-debug", "../application/urlConfig-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../application/loginOperationLogic-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "../common/loginType-debug", "../common/associateWords-debug", "./home-debug", "swiper-debug", "../common/recommendConfigInfo-debug", "../common/template/swiper_tmp-debug.html", "./template/homeRecentlySee-debug.html", "./template/vipPrivilegeList-debug.html", "./dialog-debug", "./template/accountsecurity-debug.html" ], function(require) {
    require("../cmd-lib/jqueryMd5-debug");
    ...
    var showCaptcha = require("../common/bindphone-debug").showCaptcha;
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.code == "0") {
                    ...
                    var accountsecurity = require("./template/accountsecurity-debug.html");
                    var accountsecurityTemplate = template.compile(accountsecurity)({
                        userBindInfo: res.data
                    });
                    $(".personal-center-accountsecurity").html(accountsecurityTemplate);
                } else {
                    $.toast({
                        text: res.message,
                        delay: 3e3
    ...
    $("#dialog-box").on("click", ".authentication-btn", function() {
        // 身份验证
        //   var checkIdentity
    ...
    $(document).on("click", ".authentication-code", function() {
    ...
    $("#dialog-box").on("click", ".bind-phonenumber-dialog .confirm-binding", function() {
        // 绑定手机号 换绑手机号 确认事件
    ...
    $("#dialog-box").on("click", ".set-change-password-dialog .set-change-password", function() {
        // var phonenumber = $('#dialog-box .item-phonenumber').val()
        var verificationcode = $("#dialog-box .item-verificationcode").val();
    ...
    $("#dialog-box").on("click", ".unbind-account-dialog .unbind-btn", function() {
    ...
    $("#dialog-box").on("click", ".unbind-account-dialog .unbind-account-btn", function() {
        closeRewardPop();
        bindPhoneNumber();
    });
});