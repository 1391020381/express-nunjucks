define("dist/personalCenter/userPage-debug", [ "../application/method-debug", "../application/api-debug", "../application/checkLogin-debug", "./effect-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../report/init-debug", "../report/handler-debug", "../report/columns-debug", "../application/helper-debug", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min-debug", "../cmd-lib/toast-debug", "./template/userPage/index-debug.html", "./template/userPage/rightList-debug.html", "./template/userPage/userPageList-debug.html" ], function(require, exports, module) {
