define("dist/personalCenter/userPage-debug", [ "../cmd-lib/toast-debug", "../application/method-debug", "../application/api-debug", "../application/urlConfig-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../application/loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "../common/loginType-debug", "../common/associateWords-debug", "../common/paradigm4-report-debug", "./template/userPage/index-debug.html", "./template/userPage/rightList-debug.html", "./template/userPage/userPageList-debug.html" ], function(require, exports, module) {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.code == "0") {
                    ...
                    var htmlTpl = template.compile(require("./template/userPage/index-debug.html"))({
                        data: userData
                    });
    ...
    function paradigm4Relevant(data) {
        ...
        $ajax("/detail/like/" + sceneID, "POST", {
            ...
            var htmlTpl = template.compile(require("./template/userPage/rightList-debug.html"))({
                rightList: res.data
            });
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.code == "0") {
                    ...
                    var userPageListTemplate = template.compile(require("./template/userPage/userPageList-debug.html"))({
                        uid: pageParams.uid,
                        list: res.data,
                        currentPage: current,
                        sortField: sortField,
