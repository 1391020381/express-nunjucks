define("dist/personalCenter/myvip-debug", [ "../application/method-debug", "../common/template/swiper_tmp-debug.html", "./template/vipPrivilegeList-debug.html", "./template/simplePagination-debug.html", "../common/recommendConfigInfo-debug", "../application/api-debug", "./effect-debug", "../application/checkLogin-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../application/helper-debug", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min-debug", "./home-debug", "swiper-debug", "./template/homeRecentlySee-debug.html", "./template/myvip-debug.html", "./template/vipTable-debug.html", "./template/vipTable-debug.html" ], function(require, exports, module) {
