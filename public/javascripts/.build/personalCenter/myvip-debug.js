define("dist/personalCenter/myvip-debug", [ "./dialog-debug", "../application/method-debug", "../common/template/swiper_tmp-debug.html", "./template/vipPrivilegeList-debug.html", "./template/simplePagination-debug.html", "../common/recommendConfigInfo-debug", "../application/api-debug", "../application/urlConfig-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../application/loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "../common/loginType-debug", "../common/associateWords-debug", "./home-debug", "swiper-debug", "./template/homeRecentlySee-debug.html", "./template/myvip-debug.html", "./template/vipTable-debug.html", "./template/vipTable-debug.html", "./template/vipTable-debug.html" ], function(require) {
                    ...
                    $(recommendConfigInfo.myVipRightsList.descs).each(function(index, k) {
                        if (k.list.length) {
                            if (k.pageId == "PC_M_USER_vip") {
                                ...
                                var vipPrivilegeListHtml = template.compile(vipPrivilegeList)({
                                    list: k.list
                                });
