define("dist/personalCenter/myvip-debug", [ "./dialog-debug", "../application/method-debug", "../common/template/swiper_tmp-debug.html", "./template/vipPrivilegeList-debug.html", "./template/simplePagination-debug.html", "../common/recommendConfigInfo-debug", "../application/api-debug", "../application/urlConfig-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "./home-debug", "swiper-debug", "./template/homeRecentlySee-debug.html", "./template/myvip-debug.html", "./template/vipTable-debug.html", "./template/vipTable-debug.html", "./template/vipTable-debug.html" ], function(require, exports, module) {
