define("dist/personalCenter/accountsecurity", [ "../cmd-lib/jqueryMd5", "../application/method", "../application/api", "../application/urlConfig", "../application/effect", "../application/checkLogin", "../application/login", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "./home", "swiper", "../common/recommendConfigInfo", "../common/template/swiper_tmp.html", "./template/homeRecentlySee.html", "./template/vipPrivilegeList.html", "./dialog", "./template/accountsecurity.html" ], function(require, exports, module) {
