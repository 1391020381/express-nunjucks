define("dist/personalCenter/accountsecurity", [ "../cmd-lib/jqueryMd5", "../application/method", "../application/api", "./effect", "../application/checkLogin", "../application/app", "../application/element", "../application/template", "../application/extend", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../application/helper", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min", "./home", "swiper", "../common/recommendConfigInfo", "../common/template/swiper_tmp.html", "./template/homeRecentlySee.html", "./template/vipPrivilegeList.html", "../common/bindphone", "./dialog", "./template/accountsecurity.html" ], function(require, exports, module) {
