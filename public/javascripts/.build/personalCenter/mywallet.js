define("dist/personalCenter/mywallet", [ "../cmd-lib/jquery.datepicker", "./home", "swiper", "../common/recommendConfigInfo", "../application/method", "../common/template/swiper_tmp.html", "../application/api", "../application/urlConfig", "./template/homeRecentlySee.html", "./template/vipPrivilegeList.html", "../application/effect", "../application/checkLogin", "../application/login", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../common/loginType", "../cmd-lib/upload/Q", "../cmd-lib/upload/Q.Uploader", "./template/simplePagination.html", "./template/mywallet.html", "../common/area", "../common/bankData", "./dialog" ], function(require, exports, module) {
