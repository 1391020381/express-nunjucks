define("dist/personalCenter/userPage", [ "../cmd-lib/toast", "../application/method", "../application/api", "../application/urlConfig", "../application/effect", "../application/checkLogin", "../application/login", "../application/loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../cmd-lib/myDialog", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../common/loginType", "../common/associateWords", "../common/paradigm4-report", "./template/userPage/index.html", "./template/userPage/rightList.html", "./template/userPage/userPageList.html" ], function(require, exports, module) {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.code == "0") {
                    ...
                    var htmlTpl = template.compile(require("./template/userPage/index.html"))({
                        data: userData
                    });
    ...
    function paradigm4Relevant(data) {
        ...
        $ajax("/detail/like/" + sceneID, "POST", {
            ...
            var htmlTpl = template.compile(require("./template/userPage/rightList.html"))({
                rightList: res.data
            });
