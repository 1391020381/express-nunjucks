define("dist/feedback/buyUnlogin", [ "../cmd-lib/util", "../application/method", "../pay/qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../cmd-lib/gioInfo", "../detail/template/buyUnlogin.html" ], function(require, exports, module) {
    // var $ = require("$");
    ...
    var unloginObj = {
        ...
        bindClick: function() {
            ...
            //弹出未登录购买弹窗
            var unloginBuyHtml = require("../detail/template/buyUnlogin.html");
