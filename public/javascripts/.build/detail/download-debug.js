define("dist/detail/download-debug", [ "../application/method-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../cmd-lib/loading-debug", "../cmd-lib/util-debug", "../cmd-lib/gioInfo-debug", "./common-debug", "../application/api-debug", "./template/pay_btn_tmp-debug.html", "./template/pay_middle_tmp-debug.html", "./template/pay_header.tmp-debug.html", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../application/iframe/iframe-parent-debug", "../application/iframe/messenger-debug", "../common/bilog-debug", "base64-debug", "../report/config-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug" ], function(require, exports, module) {
    // var $ = require("$");
