define("dist/detail/search-debug", [ "./template/history_tmp-debug.html", "./template/hot_search_tmp-debug.html" ], function(require) {
    // var $ = require("$");
    ...
    var buildHotSearchHtml = function(d) {
        if (d) {
            var htmlTpl = template.compile(hot_search_tmp)({
                data: d
            });
            $("#search-hot-box").html(htmlTpl);
        }
    };
    // 跳转
