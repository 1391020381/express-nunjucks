define("dist/detail/success-debug", [ "../cmd-lib/myDialog-debug", "../application/method-debug", "../application/checkLogin-debug", "../application/api-debug", "../cmd-lib/util-debug", "swiper-debug", "../application/effect-debug", "../common/recommendConfigInfo-debug", "../common/template/swiper_tmp-debug.html", "../common/bindphone-debug", "../common/coupon/couponIssue-debug", "../cmd-lib/toast-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html", "../common/bilog-debug", "base64-debug", "../report/config-debug" ], function(require, exports, module) {
    // var $ = require('$');
