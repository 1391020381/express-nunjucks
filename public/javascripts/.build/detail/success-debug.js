define("dist/detail/success-debug", [ "../cmd-lib/myDialog-debug", "../application/method-debug", "../application/checkLogin-debug", "../application/api-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../application/iframe/iframe-parent-debug", "../application/iframe/messenger-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "swiper-debug", "../application/effect-debug", "../common/recommendConfigInfo-debug", "../common/template/swiper_tmp-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html" ], function(require, exports, module) {
    // var $ = require('$');
    ...
    var swiperTemplate = require("../common/template/swiper_tmp-debug.html");
    var topBnnerTemplate = require("../common/template/swiper_tmp-debug.html");
    var getLoginQrcode = require("../application/login-debug").getLoginQrcode;
