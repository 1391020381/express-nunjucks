define("dist/detail/success-debug", [ "swiper-debug", "../cmd-lib/myDialog-debug", "../application/method-debug", "../application/checkLogin-debug", "../application/api-debug", "../application/urlConfig-debug", "../application/login-debug", "../cmd-lib/toast-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "../cmd-lib/util-debug", "../application/effect-debug", "../common/loginType-debug", "../common/recommendConfigInfo-debug", "../common/template/swiper_tmp-debug.html", "../common/bindphone-debug", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html" ], function(require, exports, module) {
