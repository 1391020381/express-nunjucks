define("dist/detail/relevantInformation", [ "../common/paradigm4-report", "../application/method", "../application/api", "../application/urlConfig", "./template/relevantInformation.html" ], function(require) {
    // 相关资料
