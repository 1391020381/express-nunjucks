define("dist/detail/buyUnlogin", [ "../cmd-lib/util", "../application/method", "../pay/qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../cmd-lib/gioInfo", "../common/bilog", "base64", "../report/config", "./template/buyUnlogin.html" ], function(require, exports, module) {
    // var $ = require("$");
