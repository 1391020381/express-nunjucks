define("dist/detail/buyUnlogin", [ "../application/api", "../cmd-lib/util", "../application/method", "../pay/qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../application/checkLogin", "../application/login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "../application/urlConfig", "../cmd-lib/gioInfo", "./common", "./template/pay_btn_tmp.html", "./template/pay_middle_tmp.html", "./template/pay_header.tmp.html", "../common/bilog-module/payFileResultForVisit_bilog", "./template/buyUnlogin.html" ], function(require, exports, module) {
    // var $ = require("$");
