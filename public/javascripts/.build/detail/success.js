define("dist/detail/success", [ "../cmd-lib/myDialog", "../application/method", "../application/checkLogin", "../application/api", "../cmd-lib/util", "swiper", "../application/effect", "../common/recommendConfigInfo", "../common/template/swiper_tmp.html", "../common/bindphone", "../common/coupon/couponIssue", "../cmd-lib/toast", "../cmd-lib/loading", "../common/coupon/template/couponCard.html", "../common/bilog", "base64", "../report/config" ], function(require, exports, module) {
    // var $ = require('$');
