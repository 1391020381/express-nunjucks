define("dist/detail/success", [ "swiper", "../cmd-lib/myDialog", "../application/method", "../application/checkLogin", "../application/api", "../application/urlConfig", "../application/login", "../cmd-lib/toast", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../cmd-lib/util", "../application/effect", "../common/loginType", "../common/recommendConfigInfo", "../common/template/swiper_tmp.html", "../common/bindphone", "../common/coupon/couponIssue", "../cmd-lib/loading", "../common/coupon/template/couponCard.html" ], function(require, exports, module) {
    require("swiper");
