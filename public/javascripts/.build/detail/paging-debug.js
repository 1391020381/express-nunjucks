define("dist/detail/paging-debug", [ "./template/img_box-debug.html", "./changeShowOverText-debug", "./download-debug", "../application/method-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../cmd-lib/loading-debug", "../cmd-lib/util-debug", "../cmd-lib/gioInfo-debug", "./common-debug", "../application/api-debug", "./template/pay_btn_tmp-debug.html", "./template/pay_middle_tmp-debug.html", "./template/pay_header.tmp-debug.html", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../application/iframe/iframe-parent-debug", "../application/iframe/messenger-debug", "../common/bilog-debug", "base64-debug", "../report/config-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "./index-debug", "../application/suspension-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../application/effect-debug", "../application/helper-debug", "./template/head_tip-debug.html", "./changeDetailFooter-debug" ], function(require, exports, module) {
    // var $ = require("$");
