define("dist/detail/paging", [ "../cmd-lib/toast", "./template/img_box.html", "./changeShowOverText", "./download", "../application/method", "../cmd-lib/myDialog", "../cmd-lib/loading", "../cmd-lib/util", "./common", "../application/api", "../application/urlConfig", "./template/pay_btn_tmp.html", "../common/loginType", "../application/checkLogin", "../application/login", "../application/loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "./changeDetailFooter" ], function(require) {
    // var $ = require("$");
    require("../cmd-lib/toast");
    var imgTmp = require("./template/img_box.html");
    var changeText = require("./changeShowOverText").changeText;
    var readMoreTextEvent = require("./changeShowOverText").readMoreTextEvent;
