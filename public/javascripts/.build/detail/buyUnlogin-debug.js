define("dist/detail/buyUnlogin-debug", [ "../cmd-lib/util-debug", "../application/method-debug", "../pay/qr-debug", "../cmd-lib/qr/qrcode.min-debug", "../cmd-lib/qr/jquery.qrcode.min-debug", "../cmd-lib/gioInfo-debug", "../common/bilog-debug", "base64-debug", "../report/config-debug", "./template/buyUnlogin-debug.html" ], function(require, exports, module) {
    // var $ = require("$");
