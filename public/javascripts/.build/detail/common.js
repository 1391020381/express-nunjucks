define("dist/detail/common", [ "../application/method", "../application/api", "../application/urlConfig", "./template/pay_btn_tmp.html", "../common/loginType" ], function(require, exports, module) {
    // var $ = require("$");
