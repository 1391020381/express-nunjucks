define("dist/detail/init", [ "../cmd-lib/lazyload", "../cmd-lib/myDialog", "../cmd-lib/loading", "./userComments", "../application/method", "../application/api", "../application/urlConfig", "./template/simplePagination.html", "./template/userComments.html", "./index", "../application/suspension", "../application/checkLogin", "../application/login", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/toast", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../application/app", "../application/element", "../application/template", "../application/extend", "../application/effect", "../common/loginType", "../application/helper", "../application/single-login", "./common", "./template/pay_btn_tmp.html", "./template/pay_middle_tmp.html", "./template/pay_header.tmp.html", "./search", "./template/history_tmp.html", "./template/hot_search_tmp.html", "./download", "../cmd-lib/gioInfo", "./paging", "./template/img_box.html", "./changeShowOverText", "./changeDetailFooter", "./expand", "./buyUnlogin", "../pay/qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../common/bilog-module/payFileResultForVisit_bilog", "./template/buyUnlogin.html", "../detail/paradigm4", "./banner", "swiper", "./template/HotSpotSearch.html" ], function(require, exports, module) {
