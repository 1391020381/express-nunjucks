define("dist/detail/download", [ "../application/method", "../cmd-lib/myDialog", "../cmd-lib/toast", "../cmd-lib/loading", "../cmd-lib/util", "../cmd-lib/gioInfo", "./common", "../application/api", "./template/pay_btn_tmp.html", "./template/pay_middle_tmp.html", "./template/pay_header.tmp.html", "../application/checkLogin", "../application/login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../report/config", "../common/bindphone", "../common/baidu-statistics" ], function(require, exports, module) {
    // var $ = require("$");
