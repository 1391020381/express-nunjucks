define("dist/detail/download", [ "../application/method", "../cmd-lib/myDialog", "../cmd-lib/toast", "../cmd-lib/loading", "../cmd-lib/util", "../cmd-lib/gioInfo", "./common", "../application/api", "./template/pay_btn_tmp.html", "./template/pay_middle_tmp.html", "./template/pay_header.tmp.html", "../application/checkLogin" ], function(require, exports, module) {
    // var $ = require("$");
