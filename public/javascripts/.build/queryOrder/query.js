 ...
 * 详情页首页
 */
define("dist/queryOrder/query", [ "../application/suspension", "../application/method", "../application/checkLogin", "../application/api", "../application/login", "../cmd-lib/jqueryMd5", "../application/iframe/iframe-parent", "../application/iframe/messenger", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../application/app", "../application/element", "../application/template", "../application/extend", "../application/effect", "../application/helper", "../detail/common", "../detail/template/pay_btn_tmp.html", "../detail/template/pay_middle_tmp.html", "../detail/template/pay_header.tmp.html", "../common/coupon/couponIssue", "../cmd-lib/loading", "../common/coupon/template/couponCard.html", "../detail/template/head_tip.html" ], function(require, exports, module) {
    // var $ = require('$');
