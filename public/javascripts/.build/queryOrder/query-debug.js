 ...
 * 详情页首页
 */
define("dist/queryOrder/query-debug", [ "../application/suspension-debug", "../application/method-debug", "../application/checkLogin-debug", "../application/api-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../application/iframe/iframe-parent-debug", "../application/iframe/messenger-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../application/app-debug", "../application/element-debug", "../application/template-debug", "../application/extend-debug", "../application/effect-debug", "../application/helper-debug", "../detail/common-debug", "../detail/template/pay_btn_tmp-debug.html", "../detail/template/pay_middle_tmp-debug.html", "../detail/template/pay_header.tmp-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html", "../detail/template/head_tip-debug.html" ], function(require, exports, module) {
    // var $ = require('$');
    ...
    var common = require("../detail/common-debug");
    require("../common/coupon/couponIssue-debug");
    var refreshTopBar = require("../application/effect-debug").refreshTopBar;
                ...
                if (res.code == 0) {
                    if (res.data.list) {
                        if (res.data.list.length > 0) {
                            var headTip = require("../detail/template/head_tip-debug.html");
