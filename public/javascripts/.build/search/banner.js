define("dist/search/banner", [ "swiper", "../application/api", "../application/urlConfig", "../common/template/swiper_tmp.html", "../common/recommendConfigInfo", "../application/method" ], function(require, exports, module) {
    require("swiper");
