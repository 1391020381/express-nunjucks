define("dist/search/search", [ "../application/method", "../application/api", "../application/urlConfig", "swiper", "../common/bilog", "base64", "../cmd-lib/util", "../report/config" ], function(require, exports, moudle) {
    // var $ = require('$');
    var method = require("../application/method");
    var api = require("../application/api");
    require("swiper");
    var clickEvent = require("../common/bilog").clickEvent, cond = decodeURIComponent(decodeURIComponent(method.getParam("cond"))), userInfo = method.getCookie("ui") ? JSON.parse(method.getCookie("ui")) : {};
    if (cond) {
