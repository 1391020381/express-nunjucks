define("dist/search/search", [ "../application/method", "../application/api", "swiper", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../common/gioPageSet" ], function(require, exports, moudle) {
    // var $ = require('$');
