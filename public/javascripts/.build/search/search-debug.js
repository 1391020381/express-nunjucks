define("dist/search/search-debug", [ "../application/method-debug", "../application/api-debug", "../application/urlConfig-debug", "swiper-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug" ], function(require, exports, moudle) {
    // var $ = require('$');
    var method = require("../application/method-debug");
    var api = require("../application/api-debug");
    require("swiper-debug");
    var clickEvent = require("../common/bilog-debug").clickEvent, cond = decodeURIComponent(decodeURIComponent(method.getParam("cond"))), userInfo = method.getCookie("ui") ? JSON.parse(method.getCookie("ui")) : {};
    if (cond) {
