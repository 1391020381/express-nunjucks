define("dist/search/search-debug", [ "../application/method-debug", "../application/api-debug", "../application/urlConfig-debug", "swiper-debug" ], function(require, exports, moudle) {
    // var $ = require('$');
