 ...
 * @Description: 筛选
 */
define("dist/cmd-lib/action-debug", [], function(require, exports, module) {
    //var jQuery = require("$");
    (function($, win, doc) {
        ...
        Actions.prototype = {
            ...
            _create: function(html) {
                ...
                if (html) {
                    ...
                    if (that.options.showFooter) {
                        footer = '<div class="screen-btn-con mui-flex">                                        ' + clBtn + "                                        " + cfBtn + "                                    </div>";
                    }
                    if (that.options.actions) {
                        bodyContent = that._creactActions(that.options.actions, $("<div class='screen-more-list'></div>"));
                    }
                    that.options.actionsWrap = '<div class="office-screen-more">                                            ' + bodyContent + "                                            " + footer + "                                        </div>";
            ...
            _creactActions: function(actions) {
                ...
                $(actions).each(function(index) {
                    var text = this.text ? this.text : "列表" + index++, action = '<a href="javascript:;" class="ui-action-sheet-item ui-border-b">' + text + "</a>";
                    _html += action;
                });
                return _html;
            },
