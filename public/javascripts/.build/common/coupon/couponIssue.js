 ...
 * 发优惠券
 */
define("dist/common/coupon/couponIssue", [ "../../cmd-lib/toast", "../../application/method", "../../cmd-lib/util", "../../cmd-lib/loading", "../../application/checkLogin", "../../application/api", "../../application/urlConfig", "../../application/login", "../../application/loginOperationLogic", "../../cmd-lib/jqueryMd5", "../bindphone", "../../cmd-lib/myDialog", "../../application/iframe/iframe-messenger", "../../application/iframe/messenger", "../baidu-statistics", "./template/couponCard.html" ], function(require, exports, module) {
    // var $ = require("$");
