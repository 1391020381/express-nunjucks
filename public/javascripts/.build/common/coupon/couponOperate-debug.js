 ...
 * 用优惠券
 */
define("dist/common/coupon/couponOperate-debug", [ "../../cmd-lib/toast-debug", "./template/options-debug.html" ], function(require, exports, module) {
    // var $ = require("$");
    require("../../cmd-lib/toast-debug");
    // var method = require('../../application/method');
    var couponOptions = require("./template/options-debug.html");
    var couponObj = {
        _index: 0,
        data: [],
        // 此为可用的优惠券
        ...
        getCouponData: function(type) {
            ...
            $.get(url, data, function(res) {
                ...
                var htmlTpl = template.compile(couponOptions)({
                    data: list
                });
