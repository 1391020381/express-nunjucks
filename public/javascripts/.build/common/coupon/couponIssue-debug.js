 ...
 * 发优惠券
 */
define("dist/common/coupon/couponIssue-debug", [ "../../cmd-lib/toast-debug", "../../application/method-debug", "../../cmd-lib/util-debug", "../../cmd-lib/loading-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/login-debug", "../../cmd-lib/jqueryMd5-debug", "../bilog-debug", "base64-debug", "../../report/config-debug", "../../cmd-lib/myDialog-debug", "../bindphone-debug", "../baidu-statistics-debug", "./template/couponCard-debug.html" ], function(require, exports, module) {
    // var $ = require("$");
