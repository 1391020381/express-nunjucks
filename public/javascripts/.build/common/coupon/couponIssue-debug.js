 ...
 * 发优惠券
 */
define("dist/common/coupon/couponIssue-debug", [ "../../cmd-lib/toast-debug", "../../application/method-debug", "../../cmd-lib/util-debug", "../../cmd-lib/loading-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/urlConfig-debug", "../../application/login-debug", "../../application/loginOperationLogic-debug", "../../cmd-lib/jqueryMd5-debug", "../bindphone-debug", "../../cmd-lib/myDialog-debug", "../../application/iframe/iframe-messenger-debug", "../../application/iframe/messenger-debug", "../baidu-statistics-debug", "./template/couponCard-debug.html" ], function(require, exports, module) {
    // var $ = require("$");
