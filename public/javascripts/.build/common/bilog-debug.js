define("dist/common/bilog-debug", [ "base64-debug", "../cmd-lib/util-debug", "../application/method-debug", "./../report/config-debug", "../application/urlConfig-debug" ], function(require, exports, module) {
    //var $ = require("$");
    var base64 = require("base64-debug").Base64;
    var util = require("../cmd-lib/util-debug");
    var method = require("../application/method-debug");
    var config = require("./../report/config-debug");
    //参数配置
    ...
    function clickEvent(cnt, that, moduleID, params) {
        ...
        if (cnt == "paySuccessBacDown") {
            ...
            $.extend(temp, {
                ...
                filePayType: payTypeMapping[page.productType],
