define("dist/pay/pay-debug", [ "../common/bilog-module/payVipResult_bilog-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../application/method-debug", "../report/config-debug", "../application/urlConfig-debug", "../common/bilog-module/payFileResult_bilog-debug", "../common/bilog-module/payPrivilegeResult_bilog-debug", "swiper-debug", "./qr-debug", "../cmd-lib/qr/qrcode.min-debug", "../cmd-lib/qr/jquery.qrcode.min-debug", "../application/api-debug", "./couponReceive-debug.html", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../common/coupon/couponOperate-debug", "../common/coupon/template/options-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html" ], function(require, exports, moudle) {
    // 自有埋点注入
    var payVipResult_bilog = require("../common/bilog-module/payVipResult_bilog-debug");
    var payFileResult_bilog = require("../common/bilog-module/payFileResult_bilog-debug");
    var payPrivilegeResult_bilog = require("../common/bilog-module/payPrivilegeResult_bilog-debug");
    ...
    var couponReceive = require("./couponReceive-debug.html");
    ...
    // 
    // 优惠券相关需要在登录后执行
    var couponObj = require("../common/coupon/couponOperate-debug");
    require("../common/coupon/couponIssue-debug");
    function getSpecialUserIds(userInfo) {
        // 获取vip列表页面展示 续费的 userIds
        $.ajax({
    ...
    $(".js-tab").each(function() {
        $(this).tab({
            ...
            callback: function($this) {
                ...
                // 价格
                var activePrice = 0;
                // $this.data('activeprice').toFixed(2); // 活动价
