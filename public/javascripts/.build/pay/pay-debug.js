define("dist/pay/pay-debug", [ "../common/bilog-module/payVipResult_bilog-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../application/method-debug", "../report/config-debug", "../common/bilog-module/payFileResult_bilog-debug", "../common/bilog-module/payPrivilegeResult_bilog-debug", "swiper-debug", "./qr-debug", "../cmd-lib/qr/qrcode.min-debug", "../cmd-lib/qr/jquery.qrcode.min-debug", "../application/urlConfig-debug", "../application/api-debug", "../common/coupon/couponOperate-debug", "../cmd-lib/toast-debug", "../common/coupon/template/options-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../cmd-lib/myDialog-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../common/coupon/template/couponCard-debug.html", "../application/effect-debug" ], function(require, exports, moudle) {
    // 自有埋点注入
