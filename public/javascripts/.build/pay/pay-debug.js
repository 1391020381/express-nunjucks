define("dist/pay/pay-debug", [ "../common/bilog-module/payVipResult_bilog-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../application/method-debug", "../report/config-debug", "../application/urlConfig-debug", "../common/bilog-module/payFileResult_bilog-debug", "../common/bilog-module/payPrivilegeResult_bilog-debug", "swiper-debug", "./qr-debug", "../cmd-lib/qr/qrcode.min-debug", "../cmd-lib/qr/jquery.qrcode.min-debug", "../application/api-debug", "./couponReceive-debug.html", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "../common/loginType-debug", "../common/coupon/couponOperate-debug", "../common/coupon/template/options-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../common/coupon/template/couponCard-debug.html" ], function(require, exports, moudle) {
    // 自有埋点注入
