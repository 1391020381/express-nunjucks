define("dist/pay/pay-debug", [ "swiper-debug", "../application/method-debug", "../cmd-lib/util-debug", "./qr-debug", "../cmd-lib/qr/qrcode.min-debug", "../cmd-lib/qr/jquery.qrcode.min-debug", "../application/api-debug", "../common/coupon/couponOperate-debug", "../cmd-lib/toast-debug", "../common/coupon/template/options-debug.html", "../common/coupon/couponIssue-debug", "../cmd-lib/loading-debug", "../application/checkLogin-debug", "../common/coupon/template/couponCard-debug.html", "../common/bilog-debug", "base64-debug", "../report/config-debug", "../application/effect-debug" ], function(require, exports, moudle) {
    //所有支付引用办公频道支付js
    // var $ = require("$");
