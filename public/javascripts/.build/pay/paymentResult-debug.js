define("dist/pay/paymentResult-debug", [ "../common/baidu-statistics-debug", "../application/method-debug", "../cmd-lib/toast2-debug", "../application/api-debug", "../application/urlConfig-debug", "./payRestult-debug.html" ], function(require) {
    console.log("聚合支付码");
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.code == "0") {
                    ...
                    var paymentRestultTemplate = template.compile(paymentRestult)({
                        orderInfo: res.data
                    });
                    $(".payment .payment-content").html(paymentRestultTemplate);
