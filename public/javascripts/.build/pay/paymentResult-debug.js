define("dist/pay/paymentResult-debug", [ "../common/baidu-statistics-debug", "../application/method-debug", "../cmd-lib/toast2-debug", "../application/api-debug", "../application/urlConfig-debug", "./payRestult-debug.html", "./go2MinApp-debug", "../cmd-lib/util-debug" ], function(require, exports, module) {
    console.log("聚合支付码");
