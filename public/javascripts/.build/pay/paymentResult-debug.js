define("dist/pay/paymentResult-debug", [ "../common/baidu-statistics-debug", "../application/method-debug", "../cmd-lib/toast-debug", "../application/api-debug", "./payRestult-debug.html" ], function(require, exports, module) {
    console.log("聚合支付码");
