define("dist/pay/pay", [ "swiper", "../application/method", "../cmd-lib/util", "./qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../application/api", "../common/coupon/couponOperate", "../cmd-lib/toast", "../common/coupon/template/options.html", "../common/coupon/couponIssue", "../cmd-lib/loading", "../application/checkLogin", "../common/coupon/template/couponCard.html", "../common/bilog", "base64", "../report/config", "../application/effect" ], function(require, exports, moudle) {
    //所有支付引用办公频道支付js
    // var $ = require("$");
    require("swiper");
