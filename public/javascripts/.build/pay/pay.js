define("dist/pay/pay", [ "../common/bilog-module/payVipResult_bilog", "../common/bilog", "base64", "../cmd-lib/util", "../application/method", "../report/config", "../common/bilog-module/payFileResult_bilog", "../common/bilog-module/payPrivilegeResult_bilog", "swiper", "./qr", "../cmd-lib/qr/qrcode.min", "../cmd-lib/qr/jquery.qrcode.min", "../application/urlConfig", "../application/api", "../common/coupon/couponOperate", "../cmd-lib/toast", "../common/coupon/template/options.html", "../common/coupon/couponIssue", "../cmd-lib/loading", "../application/checkLogin", "../application/login", "../cmd-lib/jqueryMd5", "../cmd-lib/myDialog", "../common/bindphone", "../common/baidu-statistics", "../common/coupon/template/couponCard.html", "../application/effect" ], function(require, exports, moudle) {
    // 自有埋点注入
