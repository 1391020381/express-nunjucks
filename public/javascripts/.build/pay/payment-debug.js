define("dist/pay/payment-debug", [ "../cmd-lib/toast2-debug", "../common/baidu-statistics-debug", "../application/method-debug", "../application/api-debug", "../application/urlConfig-debug" ], function(require) {
     ...
     * flag：支付flag
     * */
    function getOrderStatus(orderNo, flag) {
        if (platformCode == "m") {
