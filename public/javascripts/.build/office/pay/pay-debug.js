define("dist/office/pay/pay-debug", [ "../common/suspension-debug", "../../application/method-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/app-debug", "../../application/element-debug", "../../application/template-debug", "../../application/extend-debug", "../../common/bilog-debug", "base64-debug", "../../cmd-lib/util-debug", "../../report/config-debug", "../../application/effect-debug", "../../application/helper-debug", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min-debug", "./qr-debug", "../../cmd-lib/qr/qrcode.min-debug", "../../cmd-lib/qr/jquery.qrcode.min-debug", "./report-debug" ], function(require, exports, moudle) {
    //所有支付引用办公频道支付js
    // var $ = require("$");
