define("dist/office/pay/pay-debug", [ "../common/suspension-debug", "../../application/method-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/urlConfig-debug", "../../application/login-debug", "../../common/bilog-debug", "base64-debug", "../../cmd-lib/util-debug", "../../report/config-debug", "../../cmd-lib/myDialog-debug", "../../cmd-lib/toast-debug", "../../application/iframe/iframe-messenger-debug", "../../application/iframe/messenger-debug", "../../common/baidu-statistics-debug", "../../application/app-debug", "../../application/element-debug", "../../application/template-debug", "../../application/extend-debug", "../../application/effect-debug", "../../application/helper-debug", "../../application/single-login-debug", "../../method-debug", "../../api-debug", "../../login/checkLogin-debug", "./qr-debug", "../../cmd-lib/qr/qrcode.min-debug", "../../cmd-lib/qr/jquery.qrcode.min-debug", "./report-debug" ], function(require, exports, moudle) {
    //所有支付引用办公频道支付js
    // var $ = require("$");
