 ...
 * @auth heMing
 */
define("dist/office/common/suspension-debug", [ "../../application/method-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/urlConfig-debug", "../../application/login-debug", "../../common/bilog-debug", "base64-debug", "../../cmd-lib/util-debug", "../../report/config-debug", "../../cmd-lib/myDialog-debug", "../../cmd-lib/toast-debug", "../../application/iframe/iframe-messenger-debug", "../../application/iframe/messenger-debug", "../../common/baidu-statistics-debug", "../../application/app-debug", "../../application/element-debug", "../../application/template-debug", "../../application/extend-debug", "../../application/effect-debug", "../../application/helper-debug", "../../application/single-login-debug", "../../method-debug", "../../api-debug", "../../login/checkLogin-debug" ], function(require, exports, module) {
    // var $ = require("$");
