 ...
 * @auth heMing
 */
define("dist/office/common/suspension-debug", [ "../../application/method-debug", "../../application/checkLogin-debug", "../../application/api-debug", "../../application/app-debug", "../../application/element-debug", "../../application/template-debug", "../../application/extend-debug", "../../common/bilog-debug", "base64-debug", "../../cmd-lib/util-debug", "../../report/config-debug", "../../report/init-debug", "../../report/handler-debug", "../../report/columns-debug", "../../application/helper-debug", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min-debug" ], function(require, exports, module) {
    // var $ = require("$");
