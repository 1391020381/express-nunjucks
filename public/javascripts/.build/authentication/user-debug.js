define("dist/authentication/user-debug", [ "../cmd-lib/upload/Q-debug", "../cmd-lib/upload/Q.Uploader-debug", "./fixedTopBar-debug", "./msgVer-debug", "../cmd-lib/toast-debug", "../application/api-debug", "../application/urlConfig-debug", "../cmd-lib/util-debug", "../application/method-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug" ], function(require, exports, module) {
