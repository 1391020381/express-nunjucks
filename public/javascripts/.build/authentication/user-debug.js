define("dist/authentication/user-debug", [ "../cmd-lib/upload/Q-debug", "../cmd-lib/upload/Q.Uploader-debug", "./fixedTopBar-debug", "./msgVer-debug", "../cmd-lib/toast-debug", "../cmd-lib/util-debug", "../application/checkLogin-debug", "../application/api-debug", "../application/method-debug", "./login-debug" ], function(require, exports, module) {
