define("dist/authentication/msgVer-debug", [ "../cmd-lib/toast-debug", "../application/api-debug", "../application/urlConfig-debug" ], function(require, exports, module) {
    ...
    var bindPhone = {
        ...
        pictureVerify: function(appid, randstr, ticket, onoff) {
            ...
            $.ajax(api.user.sendSms, {
                // /gateway/cas/sms/sendSms
                type: "POST",
                data: params,
