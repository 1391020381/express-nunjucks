define("dist/authentication/index", [ "./fixedTopBar", "../cmd-lib/toast", "../cmd-lib/util", "../application/checkLogin", "../application/api", "../application/method", "./login" ], function(require, exports, module) {
    require("./fixedTopBar");
