define("dist/authentication/index", [ "./fixedTopBar", "../cmd-lib/toast", "../cmd-lib/util", "../application/effect", "../application/checkLogin", "../application/api", "../application/urlConfig", "../application/method", "../application/login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../report/config", "../cmd-lib/myDialog", "../common/bindphone", "../common/baidu-statistics" ], function(require, exports, module) {
    require("./fixedTopBar");
