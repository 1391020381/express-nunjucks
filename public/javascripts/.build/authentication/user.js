define("dist/authentication/user", [ "../cmd-lib/upload/Q", "../cmd-lib/upload/Q.Uploader", "./fixedTopBar", "./msgVer", "../cmd-lib/toast", "../application/api", "../application/urlConfig", "../cmd-lib/util", "../application/method", "../application/effect", "../application/checkLogin", "../application/login", "../common/bilog", "base64", "../report/config", "../cmd-lib/myDialog", "../application/iframe/iframe-messenger", "../application/iframe/messenger", "../common/baidu-statistics", "../common/loginType", "./template/bindPhone.html", "./template/audit.html", "./template/success.html", "./template/error.html" ], function(require, exports, module) {
