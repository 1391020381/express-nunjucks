define("dist/authentication/user", [ "../cmd-lib/upload/Q", "../cmd-lib/upload/Q.Uploader", "./fixedTopBar", "./msgVer", "../cmd-lib/toast", "../application/api", "../application/urlConfig", "../cmd-lib/util", "../application/method", "../application/effect", "../application/checkLogin", "../application/login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../report/config", "../cmd-lib/myDialog", "../common/bindphone", "../common/baidu-statistics" ], function(require, exports, module) {
