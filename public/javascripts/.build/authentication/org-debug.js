define("dist/authentication/org-debug", [ "../cmd-lib/upload/Q-debug", "../cmd-lib/upload/Q.Uploader-debug", "./fixedTopBar-debug", "./msgVer-debug", "../cmd-lib/toast-debug", "../application/api-debug", "../application/urlConfig-debug", "../cmd-lib/util-debug", "../application/method-debug", "../application/effect-debug", "../application/checkLogin-debug", "../application/login-debug", "../common/bilog-debug", "base64-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../application/iframe/iframe-messenger-debug", "../application/iframe/messenger-debug", "../common/baidu-statistics-debug", "./template/bindPhone-debug.html", "./template/audit-debug.html", "./template/success-debug.html", "./template/error-debug.html" ], function(require, exports, module) {
