 ...
 * 登录相关
 */
define("dist/application/checkLogin", [ "./api", "./urlConfig", "./method", "./login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics" ], function(require, exports, module) {
    var api = require("./api");
