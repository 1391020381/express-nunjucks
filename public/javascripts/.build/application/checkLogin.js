 ...
 * 登录相关
 */
define("dist/application/checkLogin", [ "./api", "./urlConfig", "./method", "./login", "./loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics" ], function(require, exports, module) {
    var api = require("./api");
