define("dist/application/app", [ "./method", "./element", "./template", "./extend", "./effect", "./checkLogin", "./api", "./urlConfig", "./login", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "./helper" ], function(require, exports, module) {
