define("dist/application/app", [ "./method", "./urlConfig", "./api", "./element", "./template", "./extend", "../common/bilogReport", "./effect", "./checkLogin", "./login", "./loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "../common/loginType", "./helper", "./single-login" ], function(require, exports, module) {
    var method = require("./method");
    var urlConfig = require("./urlConfig");
    var api = require("./api");
    require("./element");
    require("./extend");
    var trackEvent = require("../common/bilogReport").trackEvent;
    var trackEventLogin = require("../common/bilogReport").trackEventLogin;
    window.$ajax = $ajax;
    try {
        new ISHARE_WEB_SDK({
            //埋点初始化
