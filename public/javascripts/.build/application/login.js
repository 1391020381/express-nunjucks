define("dist/application/login", [ "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "./method", "../report/config", "./api", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone" ], function(require, exports, module) {
