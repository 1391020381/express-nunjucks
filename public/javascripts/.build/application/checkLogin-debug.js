 ...
 * 登录相关
 */
define("dist/application/checkLogin-debug", [ "./api-debug", "./urlConfig-debug", "./method-debug", "./login-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug" ], function(require, exports, module) {
