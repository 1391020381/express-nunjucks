 ...
 * 登录相关
 */
define("dist/application/checkLogin-debug", [ "./api-debug", "./urlConfig-debug", "./method-debug", "./login-debug", "./loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug" ], function(require, exports, module) {
                ...
                method.get("/node/api/getUserInfo", function(res) {
                    ...
                    if (res.code == 0 && res.data) {
                        ...
                        try {
                            ...
                            method.setCookieWithExpPath("userId", res.data.userId, 30 * 60 * 1e3, "/");
                        } catch (e) {}
                    } else {
                        handleBaiduStatisticsPush("loginResult", {
                            loginType: window.loginType && window.loginType,
