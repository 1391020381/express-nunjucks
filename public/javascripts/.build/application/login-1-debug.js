define("dist/application/login-1-debug", [ "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "./method-debug", "../report/config-debug", "./urlConfig-debug", "./api-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug" ], function(require, exports, module) {
    ...
    // 保存游客登录的传入的回调函数
    var normalPageView = require("../common/bilog-debug").normalPageView;
    window.loginType = {
        type: "wechat",
        values: {
            0: "wechat",
