define("dist/application/suspension-debug", [ "./method-debug", "./checkLogin-debug", "./api-debug", "./urlConfig-debug", "./login-debug", "./loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug", "../application/app-debug", "./element-debug", "./template-debug", "./extend-debug", "../common/bilogReport-debug", "./effect-debug", "../common/loginType-debug", "./helper-debug", "./single-login-debug" ], function(require, exports, module) {
    //var $ = require("$");
    var method = require("./method-debug");
    var login = require("./checkLogin-debug");
    // 右侧滚动
