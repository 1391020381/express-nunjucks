define("dist/application/suspension-debug", [ "./method-debug", "./checkLogin-debug", "./api-debug", "./urlConfig-debug", "./login-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug", "../application/app-debug", "./loadSentry-debug", "./element-debug", "./template-debug", "./extend-debug", "./effect-debug", "../common/loginType-debug", "./helper-debug", "./single-login-debug" ], function(require, exports, module) {
    //var $ = require("$");
