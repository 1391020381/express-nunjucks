define("dist/application/suspension-debug", [ "./method-debug", "./checkLogin-debug", "./api-debug", "./urlConfig-debug", "./login-debug", "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../application/app-debug", "./element-debug", "./template-debug", "./extend-debug", "./effect-debug", "./helper-debug" ], function(require, exports, module) {
    //var $ = require("$");
