define("dist/application/suspension", [ "./method", "./checkLogin", "./api", "./urlConfig", "./login", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "../application/app", "./element", "./template", "./extend", "./effect", "../common/loginType", "./helper", "./single-login" ], function(require, exports, module) {
    //var $ = require("$");
