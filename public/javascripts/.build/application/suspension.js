define("dist/application/suspension", [ "./method", "./checkLogin", "./api", "./urlConfig", "./login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "../application/app", "./element", "./template", "./extend", "./effect", "./helper" ], function(require, exports, module) {
    //var $ = require("$");
