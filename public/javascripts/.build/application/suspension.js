define("dist/application/suspension", [ "./method", "./checkLogin", "./api", "./urlConfig", "./login", "./loginOperationLogic", "../cmd-lib/jqueryMd5", "../common/bindphone", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "../application/app", "./element", "./template", "./extend", "../common/bilogReport", "./effect", "../common/loginType", "./helper", "./single-login" ], function(require, exports, module) {
    //var $ = require("$");
