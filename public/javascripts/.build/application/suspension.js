define("dist/application/suspension", [ "./method", "./checkLogin", "./api", "./urlConfig", "./login", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "../application/app", "./loadSentry", "./element", "./template", "./extend", "./effect", "../common/loginType", "./helper", "./single-login" ], function(require, exports, module) {
    //var $ = require("$");
