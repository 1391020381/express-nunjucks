define("dist/application/suspension", [ "./method", "./checkLogin", "./api", "../application/app", "./element", "./template", "./extend", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../report/init", "../report/handler", "../report/columns", "./helper", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min" ], function(require, exports, module) {
    //var $ = require("$");
