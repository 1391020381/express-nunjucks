// 通用头部的逻辑
define("dist/application/effect", [ "../application/checkLogin", "./api", "./urlConfig", "./method", "./login", "../cmd-lib/myDialog", "../cmd-lib/toast", "./iframe/iframe-messenger", "./iframe/messenger", "../common/baidu-statistics", "../application/method", "../common/loginType" ], function(require, exports, module) {
