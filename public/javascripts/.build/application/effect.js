// 通用头部的逻辑
define("dist/application/effect", [ "../application/checkLogin", "./api", "./method", "./login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "../application/method" ], function(require, exports, module) {
