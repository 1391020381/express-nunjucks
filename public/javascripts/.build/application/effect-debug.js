// 通用头部的逻辑
define("dist/application/effect-debug", [ "../application/checkLogin-debug", "./api-debug", "./method-debug", "./login-debug", "../cmd-lib/jqueryMd5-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../common/bindphone-debug", "../common/baidu-statistics-debug", "../application/method-debug" ], function(require, exports, module) {
