// 通用头部的逻辑
define("dist/application/effect-debug", [ "../application/checkLogin-debug", "./api-debug", "./urlConfig-debug", "./method-debug", "./login-debug", "./loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug", "../application/method-debug", "../common/loginType-debug" ], function(require, exports, module) {
    var checkLogin = require("../application/checkLogin-debug");
    var method = require("../application/method-debug");
    var api = require("./api-debug");
    var loginTypeContent = require("../common/loginType-debug");
    ...
    $(document).on("click", ".loginRedPacket-dialog .loginRedPacket-content", function(e) {
        // 区分路径 首页  详情A  详情B
        trackEvent("NE002", "normalClick", "click", {
            domID: "confirm",
            domName: "确定"
