// 通用头部的逻辑
define("dist/application/effect-debug", [ "../application/checkLogin-debug", "./api-debug", "./urlConfig-debug", "./method-debug", "./login-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug", "../application/method-debug", "../common/loginType-debug" ], function(require, exports, module) {
