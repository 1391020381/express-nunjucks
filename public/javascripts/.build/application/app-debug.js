define("dist/application/app-debug", [ "./method-debug", "./element-debug", "./template-debug", "./extend-debug", "./effect-debug", "./checkLogin-debug", "./api-debug", "./urlConfig-debug", "./login-debug", "../common/bilog-debug", "base64-debug", "../cmd-lib/util-debug", "../report/config-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug", "../common/baidu-statistics-debug", "./helper-debug" ], function(require, exports, module) {
