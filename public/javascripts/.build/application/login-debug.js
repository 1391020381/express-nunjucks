define("dist/application/login-debug", [ "./method-debug", "./loginOperationLogic-debug", "../cmd-lib/jqueryMd5-debug", "./api-debug", "./urlConfig-debug", "../common/bindphone-debug", "../cmd-lib/myDialog-debug", "../cmd-lib/toast-debug", "../application/urlConfig-debug", "./iframe/iframe-messenger-debug", "./iframe/messenger-debug" ], function(require, exports, module) {
    var method = require("./method-debug");
    var loginInit = require("./loginOperationLogic-debug").loginInit;
    require("../cmd-lib/myDialog-debug");
    require("../cmd-lib/toast-debug");
    var urlConfig = require("../application/urlConfig-debug");
    var IframeMessenger = require("./iframe/iframe-messenger-debug");
