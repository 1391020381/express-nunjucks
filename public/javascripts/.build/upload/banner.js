define("dist/upload/banner", [ "swiper", "../application/method", "../application/api", "../application/urlConfig", "../common/template/swiper_tmp.html", "../common/recommendConfigInfo" ], function(require, exports, module) {
    require("swiper");
