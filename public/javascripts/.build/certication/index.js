define("dist/certication/index", [ "./fixedTopBar", "../cmd-lib/toast", "../cmd-lib/util", "../application/checkLogin", "../application/method", "../application/api", "./login" ], function(require, exports, module) {
    require("./fixedTopBar");
