define(function (require, exports, moudle) {
    ...
    var ValidateClick = function () {
         ...
         */
        function TimerClock() {
            this.maxTimes = 60;//计时周期
            this.times = 1000;//计时步伐
            this.timer = null;
            this.ele = null;
            this.callback = null;
             ...
             * @param callback回调函数
             */
            this.showTimeClock = function (ele, beforeShow, callback) {//倒计时
                this.ele = ele;
        ...
        this.execute = function (data, callbcak) {
            ...
            var captcha = $.trim($captcha.find("input").val());//去空格
            var msg = null;
        ...
        this.sendSms = function (data) {
            ...
            //todo 本地测试用
            //$.get('/cas-api/sendSms?terminal=pc&businessSys=ishare' + data, _this.callback);
        }
    }
