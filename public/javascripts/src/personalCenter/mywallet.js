define(function (require) {
    ...
    function handleWithdrawalRecordData(res) {
        ...
        var mywalletTemplate = template.compile(mywallet)({ list: list || [], mywalletType: mywalletType });
    ...
    $(document).on('change', '.mywallet .item-province', function () { // 北京市 天津市 重庆市  上海市 澳门 香港
    ...
    $(document).on('input', '.withdrawal-application-dialog .amount', function () { // 查询个人提现扣税结算
    ...
    $(document).on('click', '.withdrawal-application-dialog .confirm-btn', function () { // 申请提现
    ...
    $(document).on('click', '.withdrawal-application-dialog .cancel-btn', function () { // 隐藏dialog
        closeRewardPop();
    });
    ...
    $(document).on('click', '.send-email-dialog .submit-btn', function () { // 导出
    ...
    $(document).on('change', '.receiving-bank .item-bank', function () {
        ...
        currentBankName && currentBankName == '其他' ?
            $('.mywallet .item-bank-name').show() : $('.mywallet .item-bank-name').hide();
    });
