        ...
        $.dialog.prototype = {
            ...
            _build : function(html){
                ...
                if(html){
                    ...
                    _html = '<div class="m-dialog" style="z-index:'+this.options.getZindex+';">\
								<div class="m-d-header">\
									<h2 style="width:' + this.options.width + ';">' + this.options.title + '</h2>\
									<a href="javascript:;" class="btn-close">X</a>\
								</div>\
								<div class="m-d-body" style="width:' + this.options.width + ';height:' + this.options.height + ';">\
									'+ bodyContent +'\
                                </div>' + footer + '</div>';
                }
