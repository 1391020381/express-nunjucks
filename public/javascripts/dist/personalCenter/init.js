...
define("dist/personalCenter/home", [ "swiper", "dist/common/recommendConfigInfo", "dist/application/method", "dist/application/api", "dist/application/urlConfig", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType" ], function(require, exports, module) {
    require("swiper");
...
define("dist/personalCenter/mycollectionAndDownLoad", [ "dist/application/method", "dist/application/api", "dist/application/urlConfig", "dist/personalCenter/dialog", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/personalCenter/home", "swiper", "dist/common/recommendConfigInfo" ], function(require, exports, module) {
    var method = require("dist/application/method");
    var api = require("dist/application/api");
    ...
    var receiveCoupon = require("dist/personalCenter/template/receiveCoupon.html");
    var commentDialogContent = require("dist/personalCenter/template/commentDialogContent.html");
    var score = 0;
    var isAppraise = 0;
    var tagList = [];
    // 评论标签
...
define("dist/personalCenter/myvip", [ "dist/personalCenter/dialog", "dist/application/method", "dist/common/recommendConfigInfo", "dist/application/api", "dist/application/urlConfig", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/personalCenter/home", "swiper" ], function(require, exports, module) {
    var type = window.pageConfig && window.pageConfig.page.type;
...
define("dist/personalCenter/myorder", [ "dist/application/method", "dist/application/api", "dist/application/urlConfig", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/personalCenter/home", "swiper", "dist/common/recommendConfigInfo" ], function(require, exports, module) {
    var method = require("dist/application/method");
    var api = require("dist/application/api");
    var type = window.pageConfig && window.pageConfig.page.type;
    var isLogin = require("dist/application/effect").isLogin;
...
define("dist/personalCenter/personalinformation", [ "dist/application/api", "dist/application/urlConfig", "dist/application/method", "dist/cmd-lib/jquery.datepicker", "dist/common/area", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/personalCenter/home", "swiper", "dist/common/recommendConfigInfo" ], function(require, exports, module) {
    var api = require("dist/application/api");
    var method = require("dist/application/method");
...
define("dist/personalCenter/mywallet", [ "dist/cmd-lib/jquery.datepicker", "dist/personalCenter/home", "swiper", "dist/common/recommendConfigInfo", "dist/application/method", "dist/application/api", "dist/application/urlConfig", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/cmd-lib/upload/Q", "dist/cmd-lib/upload/Q.Uploader", "dist/common/area", "dist/common/bankData", "dist/personalCenter/dialog" ], function(require, exports, module) {
    require("dist/cmd-lib/jquery.datepicker");
    var type = window.pageConfig && window.pageConfig.page.type;
    var getUserCentreInfo = require("dist/personalCenter/home").getUserCentreInfo;
    var isLogin = require("dist/application/effect").isLogin;
    ...
    var oneweekdate = new Date(new Date().getTime() - 15 * 24 * 3600 * 1e3);
    ...
    function getFinanceAccountInfo(isGetEdit) {
        // 查询个人财务信息
        $.ajax({
            headers: {
                Authrization: method.getCookie("cuk")
            ...
            success: function(res) {
                if (res.code == "0") {
                    ...
                    if (mywalletType == "3") {
                        ...
                        if (res.data.isEdit || res.data.isEdit == null) {
                            // 默认
                            $(".financial-records-btn .submit-btn").attr("data-isedit", 1);
                        } else {
    ...
    function handleMyWalletListData(res) {
        ...
        $(".end-time-input").datePicker({
            maxDate: currentDate,
            currentDate: endTime || new Date(new Date().getTime()).format("yyyy-MM-dd")
        });
        $(".start-time-input").datePicker({
            maxDate: currentDate,
            currentDate: startTime || new Date(oneweekdate).format("yyyy-MM-dd")
        });
        handlePagination(res.data && res.data.totalPages, res.data && res.data.currentPage);
    }
    ...
    $(document).on("input", ".withdrawal-application-dialog .amount", function(e) {
        ...
        if (financeAccountInfo.userTypeName != "机构") {
            utils.debounce(getPersonalAccountTax((withdrawPrice * 100).toFixed(), 1e3));
        }
    });
    ...
    function fullWithdrawal() {
        ...
        if (financeAccountInfo.userTypeName != "机构") {
            getPersonalAccountTax((balance * 100).toFixed() - 1e4);
        }
    }
