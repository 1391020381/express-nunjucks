...
define("dist/search/login", [ "dist/application/checkLogin", "dist/application/api", "dist/application/method", "dist/application/app", "dist/application/element", "dist/application/template", "dist/application/extend", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/report/init", "dist/report/handler", "dist/report/columns", "dist/application/helper", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min", "dist/application/suspension" ], function(require, exports, module) {
    // var $ = require("$");
    ...
    var suspension = require("dist/application/suspension");
    //右侧导航的信息
    //推荐买vip;
    $(".tui-search-vip").show();
    //检查是否登陆
...
define("dist/search/search", [ "dist/application/method", "dist/application/api", "swiper", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/common/gioPageSet" ], function(require, exports, moudle) {
    // var $ = require('$');
    var method = require("dist/application/method");
    var api = require("dist/application/api");
    require("swiper");
    var clickEvent = require("dist/common/bilog").clickEvent;
    //页面级埋点
    var gioPageSet = require("dist/common/gioPageSet");
    gioReport();
    setInputValue();
    // gebyPosition();
    conditionChange();
