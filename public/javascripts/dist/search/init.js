...
define("dist/search/search", [ "dist/application/method", "dist/application/api", "dist/application/urlConfig", "swiper", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config" ], function(require, exports, moudle) {
    // var $ = require('$');
    var method = require("dist/application/method");
    var api = require("dist/application/api");
    require("swiper");
    var clickEvent = require("dist/common/bilog").clickEvent, cond = decodeURIComponent(decodeURIComponent(method.getParam("cond"))), userInfo = method.getCookie("ui") ? JSON.parse(method.getCookie("ui")) : {};
    if (cond) {
...
define("dist/search/banner", [ "dist/application/api", "dist/application/urlConfig", "dist/common/recommendConfigInfo", "dist/application/method" ], function(require, exports, module) {
    var api = require("dist/application/api");
