define("dist/application/app", [ "./method", "./element", "./template", "./extend", "./effect", "./checkLogin", "./api", "./login", "../cmd-lib/jqueryMd5", "../common/bilog", "base64", "../cmd-lib/util", "../report/config", "../cmd-lib/myDialog", "../cmd-lib/toast", "../common/bindphone", "../common/baidu-statistics", "./helper" ], function(require, exports, module) {
