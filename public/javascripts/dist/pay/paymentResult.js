define("dist/pay/paymentResult", [ "../common/baidu-statistics", "../application/method", "../cmd-lib/toast", "../application/api", "./payRestult.html" ], function(require, exports, module) {
    console.log("聚合支付码");
