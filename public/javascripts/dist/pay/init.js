...
define("dist/pay/pay", [ "dist/common/bilog-module/payVipResult_bilog", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/application/method", "dist/report/config", "dist/application/urlConfig", "dist/common/bilog-module/payFileResult_bilog", "dist/common/bilog-module/payPrivilegeResult_bilog", "swiper", "dist/pay/qr", "dist/cmd-lib/qr/qrcode.min", "dist/cmd-lib/qr/jquery.qrcode.min", "dist/application/api", "dist/application/effect", "dist/application/checkLogin", "dist/application/login", "dist/cmd-lib/myDialog", "dist/cmd-lib/toast", "dist/application/iframe/iframe-messenger", "dist/application/iframe/messenger", "dist/common/baidu-statistics", "dist/common/loginType", "dist/common/coupon/couponOperate", "dist/common/coupon/couponIssue", "dist/cmd-lib/loading" ], function(require, exports, moudle) {
    // 自有埋点注入
    ...
    var couponReceive = require("dist/pay/couponReceive.html");
    ...
    // 
    // 优惠券相关需要在登录后执行
    var couponObj = require("dist/common/coupon/couponOperate");
    require("dist/common/coupon/couponIssue");
    //生成二维码
    function initPage(userInfo) {
        window.pageConfig.params.fileDiscount = userInfo.fileDiscount;
        // 获取用户折扣 在优惠券使用
        if (userInfo.isVip == 1) {
    ...
    function startCouponReceive(couponList, callback) {
        ...
        var _html = template.compile(couponReceive)({
            data: data
        });
    ...
    function handleOrderResultInfo() {
        ...
        if (isAutoRenew == "1") {
            goodsType = $(".renewal-radio #renewal").attr("checked") ? 12 : goodsType;
        }
        // 组装创建订单的参数
        var temp = {
            //  
    ...
    function getFileInfoById(id, callback) {
        ...
        $.ajax({
            type: "POST",
            url: api.normalFileDetail.getFileDetailNoTdk,
            // '/gateway/content/getFileDetailNoTdk'
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            data: JSON.stringify(params),
            success: function(response) {
...
// vip支付结果-自有埋点
define("dist/common/bilog-module/payVipResult_bilog", [ "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/application/method", "dist/report/config", "dist/application/urlConfig" ], function(require, exports, module) {
...
// 现金文档支付结果-自有埋点
define("dist/common/bilog-module/payFileResult_bilog", [ "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/application/method", "dist/report/config", "dist/application/urlConfig" ], function(require, exports, module) {
    var Bilog = require("dist/common/bilog");
    var Method = require("dist/application/method");
    /**
     * 上报数据
...
// 特权支付结果-自有埋点
define("dist/common/bilog-module/payPrivilegeResult_bilog", [ "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/application/method", "dist/report/config", "dist/application/urlConfig" ], function(require, exports, module) {
    var Bilog = require("dist/common/bilog");
    var Method = require("dist/application/method");
