 ...
 * 详情页首页
 */
define("dist/queryOrder/query", [ "dist/application/suspension", "dist/application/method", "dist/application/checkLogin", "dist/application/api", "dist/application/app", "dist/application/element", "dist/application/template", "dist/application/extend", "dist/common/bilog", "base64", "dist/cmd-lib/util", "dist/report/config", "dist/report/init", "dist/report/handler", "dist/report/columns", "dist/application/helper", "//static3.iask.cn/resource/js/plugins/pc.iask.login.min", "dist/detail/common", "dist/common/coupon/couponIssue", "dist/cmd-lib/toast", "dist/cmd-lib/loading" ], function(require, exports, module) {
    // var $ = require('$');
...
define("dist/queryOrder/success", [ "dist/application/method", "dist/application/checkLogin", "dist/application/api", "dist/cmd-lib/util", "dist/common/bindphone", "dist/common/coupon/couponIssue", "dist/cmd-lib/toast", "dist/cmd-lib/loading", "dist/common/bilog", "base64", "dist/report/config" ], function(require, exports, module) {
    // var $ = require('$');
    var method = require("dist/application/method");
    var login = require("dist/application/checkLogin");
    var utils = require("dist/cmd-lib/util");
